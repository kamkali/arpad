...
"[project]/src/components/OnScrollAnimator.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AnimatedCounter({ from = 0, to, duration = 1.5, className, prefix = "", suffix = "" }) {
    ...
    const [displayValue, setDisplayValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(to); // Always start with final value
...
//# sourceMappingURL=src_components_bdeb6ed4._.js.map