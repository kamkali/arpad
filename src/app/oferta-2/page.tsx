...
export default function OfertaPage() {
  return (
    <div className="container py-12 px-4 md:px-6">
      <article className="prose prose-lg max-w-none prose-h2:text-primary prose-h2:font-headline prose-h3:text-primary prose-h3:font-headline">
        <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl text-primary font-headline text-center mb-12">
          Oferta
        </h1>

        <section>
          <h2 className="text-2xl md:text-3xl font-bold">Zakres usług</h2>
        ...
        <section className="mt-16">
          <h2 className="text-2xl md:text-3xl font-bold">Wycena usługi</h2>
          <p className="mt-4">
          ...
          <div className="overflow-x-auto mt-6">
            <Table>
                ...
                <TableBody>
                    <TableRow><TableCell colSpan={3} className="font-bold bg-primary/10">Dokumentacja Aktowa</TableCell></TableRow>
                    ...
                    <TableRow><TableCell colSpan={3} className="font-bold bg-primary/10">Dokumentacja Pracownicza</TableCell></TableRow>
                    ...
                    <TableRow><TableCell colSpan={3} className="font-bold bg-primary/10">Dokumentacja Specjalistyczna</TableCell></TableRow>
                    ...
                    <TableRow><TableCell colSpan={3} className="font-bold bg-primary/10">Dokumentacja Techniczna</TableCell></TableRow>
                    ...
                    <TableRow><TableCell colSpan={3} className="font-bold bg-primary/10">Prace Dodatkowe</TableCell></TableRow>
        ...
        <section className="mt-16">
          <h2 className="text-2xl md:text-3xl font-bold">Przechowalnictwo</h2>
          <p className="mt-4">
          ...
          <h3 className="text-xl md:text-2xl font-bold mt-8">Wykaz firm</h3>
          <ul className="list-disc pl-5 mt-4 space-y-2 text-base">
