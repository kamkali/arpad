    ...
    <div className="container py-12 px-4 md:px-6">
      <article className="prose prose-lg max-w-none prose-h2:text-primary prose-h2:font-headline prose-h3:text-primary prose-h3:font-headline">
        ...
        <section className="mt-16">
          <h2 className="text-2xl md:text-3xl font-bold">Wykaz zlikwidowanych firm, których dokumentacja osobowa i płacowa jest przechowywana w naszym archiwum depozytowym</h2>
        ...
        <section className="mt-16">
            <h2 className="text-2xl md:text-3xl font-bold">Wycena usługi / Informacja handlowa</h2>
            <p className="mt-4">
        ...
        <section id="rodo" className="mt-16 p-6 bg-primary/10 rounded-lg">
          <h2 className="text-2xl md:text-3xl font-bold">RODO</h2>
          <p className="mt-4">
        ...
        <section className="mt-16">
            <h2 className="text-2xl md:text-3xl font-bold text-center">Napisz do nas</h2>
            <div className="mx-auto w-full max-w-4xl grid md:grid-cols-2 gap-12 mt-8">
            <div className="text-left space-y-4 my-auto">
              <h3 className="text-xl font-bold text-primary">Dane kontaktowe</h3>
