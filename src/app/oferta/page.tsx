...
const services = [
    ...
    { icon: <FileCog />, title: "Opracowywanie normatywów", description: "Tworzenie i wdrażanie kluczowych dokumentów, jak instrukcje kancelaryjne i wykazy akt." },
    { icon: <Wrench />, title: "Bieżąca obsługa archiwów", description: "Kompleksowa, stała opieka nad archiwami zakładowymi i składnicami akt." },
    { icon: <Users />, title: "Szkolenia dla pracowników", description: "Praktyczne szkolenia dla personelu odpowiedzialnego za prowadzenie archiwów i składnic." },
    { icon: <Database />, title: "Wdrażanie systemów ewidencji", description: "Implementacja nowoczesnych, elektronicznych systemów do ewidencji zasobów archiwalnych." },
                  ...
                  <Table>
                      <TableHeader>
                          <TableRow>
                              ...
                              <TableHead className="font-semibold text-right w-1/3">Cena Jednostkowa (PLN netto)</TableHead>
                          </TableRow>
                      </TableHeader>
                      <TableBody>
                          ...
                          <TableRow><TableCell className="pl-12">Dokumentacja finansowo-księgowa i obrotu gospodarczego</TableCell><TableCell className="text-right">Cena do uzgodnienia</TableCell></TableRow>
                          <TableRow><TableCell className="pl-12">Dokumentacja działalności podstawowej</TableCell><TableCell className="text-right">Cena do uzgodnienia</TableCell></TableRow>
                          ...
                          <TableRow><TableCell className="pl-8 font-medium">Konstrukcyjna i technologiczna (kategorii „B”)</TableCell><TableCell className="text-right">Cena do uzgodnienia</TableCell></TableRow>
                          ...
                          <TableRow><TableCell className="pl-8 font-medium">Inne rodzaje dokumentacji (geodezyjna, foto, itp.)</TableCell><TableCell className="text-right">Cena umowna</TableCell></TableRow>
                      </TableBody>
                  </Table>
              </Card>
